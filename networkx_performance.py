...
if __name__ == '__main__':
    ...
    t = triangles(G)
    logging.info(f'SOC_LiveJournal graph clustering CPU {t} seconds')
    t = pagerank(G)
    logging.info(f'SOC_LiveJournal graph Pagerank CPU {t} seconds')
    t = betweenness_centrality(G)
    logging.info(f'SOC_LiveJournal graph Betweenness_centrality CPU {t} seconds')
    logging.info('################################################')